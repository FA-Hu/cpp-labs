...
public:
	Route() {
		m_start = "Moscow";
		m_start_coords = { 300, 300 };
		m_end = "Paris";
		m_end_coords = { 500, 600 };
		_calc();
	}

	Route(const string& start_city, const Point& start_city_coords, const string& end_city, const Point& end_city_coords) {
		m_start = start_city;
	...
	Route(const string& start_city, const Point& start_city_coords) {
		m_start = start_city;
		m_start_coords = start_city_coords;
		m_end = "Paris";
		m_end_coords = { 500, 600 };
